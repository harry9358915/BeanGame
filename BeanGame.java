...
public class BeanGame extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Scene scene = new Scene(new LinePane(),1000,1000);
...
class  LinePane extends Pane {
	public LinePane(){
		Polygon polygon = new Polygon();//set the side
		...
		getChildren().addAll(polygon,line1,line2,line3,line4,line5,line6,line7,circle2,circle3,circle4,circle5,circle6,circle7,circle8,circle9,circle10,circle11,circle12,circle13,circle14,circle15,circle16,circle17,circle18,circle19,circle20,circle21,circle22,circle23,circle25,circle26,circle27,circle28,circle29,circle30);
